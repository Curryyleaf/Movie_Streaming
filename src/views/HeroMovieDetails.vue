<template>
    <div
    :class="['inset-0 max-w-full overflow-x-clip bg-cover -z-10  box-border bg-center ']"
      :style="backgroundImageStyle"

  >
          <div class="flex flex-col h-auto w-full items-center backdrop-blur-md backdrop-brightness-75 justify-center relative   text-white p-4 md:p-8">
      ...
      <div class="flex flex-col md:flex-row mb-8 " v-if="movieDetails">
        ...
        <div class="md:ml-6">
          ...
          <div class="flex items-center mb-4">
            <span class="text-yellow-400">{{ movieDetails.vote_average }}</span>
...
export default {
  ...
  computed: {
    formattedReleaseDate() {
      ...
      return new Date(this.movieDetails.release_date).toLocaleDateString('en-US', options);
    },
        backgroundImageStyle() {
      const imageUrl = `https://image.tmdb.org/t/p/w500${this.movieDetails.backdrop_path}`;
      return {
  ...
  methods: {
    ...
    mounted() {
        console.log('okay owring 1dt one ');
